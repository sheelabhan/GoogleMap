...
public class SearchActivity extends FragmentActivity implements OnMapReadyCallback {
  ...
  CameraUpdate center,zoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(position>-1) loadMap(position);
                else
    ...
    private void fillArrayListAndSetAdapter()
    {
        ...
        latitudeLongitudeList.add(new LatitudeLongitude(27.7127827, 85.3265391,"Hotel Brihasapati"));
...
public void loadMap(int position) {
    ...
    markerName= map.addMarker(new MarkerOptions().position(new LatLng(latitude,
